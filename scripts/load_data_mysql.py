...
if __name__ == "__main__":
    ...
    df_livros = read_csv(
        "/home/jackson/pipeline-python-mongo-mysql/data/tabela_livros.csv"
    )
    ...
    df_produtos = read_csv(
        "/home/jackson/pipeline-python-mongo-mysql/data/tabela_2021_em_diante.csv"
    )
    add_product_data(
        cnx, cursor, df_produtos, "dbprodutos", "tb_produtos_2021_em_diante"
    )
